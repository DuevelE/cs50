...
document.addEventListener("DOMContentLoaded", function(event) {
	...
	function stackedCards () {
		...
		var elementsMargin = 8; //Define the distance of each element when the stacked options are bottom or top.
		...
		var ary = document.querySelectorAll("input");
		var c = 0;
...
function update(New, num){
    ...
    var s2 = num.toString();
	insert = s1.concat(s2);
	var final = document.getElementById(insert).innerHTML;
	
    elem.value = old + " " + New + final;
}
